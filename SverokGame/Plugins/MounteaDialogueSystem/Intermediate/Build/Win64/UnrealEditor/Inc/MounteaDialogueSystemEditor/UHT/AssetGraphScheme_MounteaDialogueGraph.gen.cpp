...
template<> MOUNTEADIALOGUESYSTEMEDITOR_API UScriptStruct* StaticStruct<FAssetSchemaAction_MounteaDialogueGraph_NewEdge>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_3529645248(TEXT("/Script/MounteaDialogueSystemEditor"),
		Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Projects_LIA_Sverok_SverokGame_Plugins_MounteaDialogueSystem_Source_MounteaDialogueSystemEditor_Private_GraphScheme_AssetGraphScheme_MounteaDialogueGraph_h_Statics::ScriptStructInfo),
		nullptr, 0);
